...
const translations: Record<AppLocale, TranslationTree> = {
  en: {
    common: {
      ...
      sessionUnavailableSubtitle: "Your admin session is unavailable. Restore access to continue.",
      bookingsHeroSubtitle: "Manage bookings, create reservations, update statuses, and keep daily salon flow under control.",
      bookingFlowConnectedSubtitle: "Your active session can create bookings, update statuses, reschedule appointments, and manage salon operations.",
      dateTimeInputPlaceholder: "YYYY-MM-DDTHH:MM",
      bookingNotesPlaceholder: "Booking notes",
      clientFieldsRequired: "Full name and phone are required",
      ...
      deleteClientConfirmMessage: "This will permanently remove this client from the salon system.",
      clientDeletedSuccessfully: "Client deleted successfully",
      clientRegistryHeroSubtitle: "Manage your client registry, update details, and add new salon leads.",
      clientRegistryConnected: "Client Registry Connected",
      clientRegistryConnectedSubtitle: "Your session is active and ready to create, edit, and manage salon client records.",
      createClientEntrySubtitle: "Add a polished client profile to the salon system.",
      noClientsYetSubtitle: "Create your first client profile to start building your salon customer base.",
      noMatchingClientsSubtitle: "Try a different search term or clear the search field.",
      serviceCatalogHeroSubtitle: "Manage your premium service catalog, pricing strategy, duration, and activation state.",
      deleteServiceConfirmMessage: "This will permanently remove this service from your catalog.",
  ...
  hy: {
    common: {
      ...
      exportPdfReport: "Արտահանել PDF հաշվետվությունը",

      sessionUnavailableSubtitle: "Ադմին սեսիան անհասանելի է։ Վերականգնիր մուտքը շարունակելու համար։",
      bookingsHeroSubtitle: "Կառավարիր ամրագրումները, ստեղծիր գրանցումներ, փոխիր կարգավիճակները և պահիր օրվա աշխատանքային հոսքը վերահսկողության տակ։",
      bookingFlowConnectedSubtitle: "Քո ակտիվ սեսիան կարող է ստեղծել ամրագրումներ, փոխել կարգավիճակներ, վերապլանավորել այցերը և կառավարել սրահի աշխատանքը։",
      dateTimeInputPlaceholder: "YYYY-MM-DDTHH:MM",
      bookingNotesPlaceholder: "Ամրագրման նշումներ",
      clientFieldsRequired: "Լրիվ անունն ու հեռախոսահամարը պարտադիր են",
      clientCreatedSuccessfully: "Հաճախորդը հաջողությամբ ստեղծվեց",
      clientUpdatedSuccessfully: "Հաճախորդի տվյալները հաջողությամբ թարմացվեցին",
      deleteClientTitle: "Ջնջե՞լ հաճախորդին",
      deleteClientConfirmMessage: "Սա վերջնականապես կհեռացնի հաճախորդին սրահի համակարգից։",
      clientDeletedSuccessfully: "Հաճախորդը հաջողությամբ ջնջվեց",
      clientRegistryHeroSubtitle: "Կառավարիր հաճախորդների գրանցամատյանը, թարմացրու տվյալները և ավելացրու նոր հաճախորդներ։",
      clientRegistryConnected: "Հաճախորդների գրանցամատյանը միացված է",
      clientRegistryConnectedSubtitle: "Քո սեսիան ակտիվ է և պատրաստ է ստեղծելու, խմբագրելու և կառավարելու հաճախորդների տվյալները։",
      createClientEntrySubtitle: "Ավելացրու կոկիկ հաճախորդի պրոֆիլ սրահի համակարգում։",
      noClientsYetSubtitle: "Ստեղծիր առաջին հաճախորդի պրոֆիլը՝ սրահի հաճախորդների բազան աճեցնելու համար։",
      noMatchingClientsSubtitle: "Փորձիր այլ որոնման բառ կամ մաքրիր որոնման դաշտը։",
      serviceCatalogHeroSubtitle: "Կառավարիր ծառայությունների կատալոգը, գնային ռազմավարությունը, տևողությունը և ակտիվության վիճակը։",
      deleteServiceConfirmMessage: "Սա վերջնականապես կհեռացնի ծառայությունը քո կատալոգից։",
  ...
  ru: {
    common: {
      ...
      sessionUnavailableSubtitle: "Сессия администратора недоступна. Восстановите доступ, чтобы продолжить.",
      bookingsHeroSubtitle: "Управляйте записями, создавайте бронирования, меняйте статусы и держите ежедневный поток салона под контролем.",
      bookingFlowConnectedSubtitle: "Активная сессия позволяет создавать записи, менять статусы, переносить визиты и управлять работой салона.",
      dateTimeInputPlaceholder: "YYYY-MM-DDTHH:MM",
      bookingNotesPlaceholder: "Заметки к записи",
      clientFieldsRequired: "Полное имя и телефон обязательны",
      clientCreatedSuccessfully: "Клиент успешно создан",
      clientUpdatedSuccessfully: "Клиент успешно обновлён",
      deleteClientTitle: "Удалить клиента?",
      deleteClientConfirmMessage: "Это навсегда удалит клиента из системы салона.",
      clientDeletedSuccessfully: "Клиент успешно удалён",
      clientRegistryHeroSubtitle: "Управляйте реестром клиентов, обновляйте данные и добавляйте новых клиентов салона.",
      clientRegistryConnected: "Реестр клиентов подключён",
      clientRegistryConnectedSubtitle: "Ваша сессия активна и готова к созданию, редактированию и управлению клиентскими записями.",
      createClientEntrySubtitle: "Добавьте аккуратный профиль клиента в систему салона.",
      noClientsYetSubtitle: "Создайте первый профиль клиента, чтобы начать формировать клиентскую базу салона.",
      noMatchingClientsSubtitle: "Попробуйте другой поисковый запрос или очистите поле поиска.",
      serviceCatalogHeroSubtitle: "Управляйте каталогом услуг, ценовой стратегией, длительностью и активностью услуг.",
      deleteServiceConfirmMessage: "Это навсегда удалит услугу из вашего каталога.",
  ...
  fr: {
    common: {
      ...
      sessionUnavailableSubtitle: "Votre session administrateur est indisponible. Restaurez l’accès pour continuer.",
      bookingsHeroSubtitle: "Gérez les réservations, créez des rendez-vous, mettez à jour les statuts et gardez le flux quotidien du salon sous contrôle.",
      bookingFlowConnectedSubtitle: "Votre session active peut créer des réservations, modifier les statuts, reprogrammer les rendez-vous et gérer les opérations du salon.",
      dateTimeInputPlaceholder: "YYYY-MM-DDTHH:MM",
      bookingNotesPlaceholder: "Notes de réservation",
      clientFieldsRequired: "Le nom complet et le téléphone sont obligatoires",
      ...
      deleteClientConfirmMessage: "Cela supprimera définitivement le client du système du salon.",
      clientDeletedSuccessfully: "Client supprimé avec succès",
      clientRegistryHeroSubtitle: "Gérez votre registre clients, mettez à jour les détails et ajoutez de nouveaux prospects au salon.",
      clientRegistryConnected: "Registre clients connecté",
      clientRegistryConnectedSubtitle: "Votre session est active et prête à créer, modifier et gérer les fiches clients du salon.",
      createClientEntrySubtitle: "Ajoutez un profil client soigné au système du salon.",
      noClientsYetSubtitle: "Créez votre première fiche client pour commencer à construire la base clients du salon.",
      noMatchingClientsSubtitle: "Essayez un autre terme de recherche ou effacez le champ de recherche.",
      serviceCatalogHeroSubtitle: "Gérez votre catalogue de services premium, la stratégie tarifaire, la durée et l’état d’activation.",
      deleteServiceConfirmMessage: "Cela supprimera définitivement ce service de votre catalogue.",
