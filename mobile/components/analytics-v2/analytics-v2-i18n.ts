...
const ANALYTICS_V2_SURFACE_ROWS = [
  ...
  ["Sat", "Շբթ", "Сб", "Sam"],
  ["Sun", "Կիր", "Вс", "Dim"],
  ["Current Period Revenue", "Ընթացիկ ժամանակահատվածի եկամուտ", "Выручка за текущий период", "Revenu de la période actuelle"],
  ["Previous Period Revenue", "Նախորդ ժամանակահատվածի եկամուտ", "Выручка за предыдущий период", "Revenu de la période précédente"],
  ["Previous interval", "Նախորդ միջակայք", "Предыдущий интервал", "Intervalle précédent"],
  ["Change vs previous interval", "Փոփոխություն՝ նախորդ միջակայքի համեմատ", "Изменение к предыдущему интервалу", "Écart par rapport à l’intervalle précédent"],
  ["Change % vs previous interval", "Փոփոխություն %՝ նախորդ միջակայքի համեմատ", "Изменение, % к предыдущему интервалу", "Variation % par rapport à l’intervalle précédent"],
  ["Share of current period", "Ընթացիկ ժամանակահատվածի բաժին", "Доля текущего периода", "Part de la période actuelle"],
  ["Interval", "Միջակայք", "Интервал", "Intervalle"],
  ["Expand revenue chart", "Մեծացնել եկամտի գրաֆիկը", "Развернуть график выручки", "Agrandir le graphique des revenus"],
  ["Close expanded revenue chart", "Փակել եկամտի մեծացված գրաֆիկը", "Закрыть развёрнутый график выручки", "Fermer le graphique des revenus agrandi"],
  ["Selected revenue period", "Ընտրված եկամտի ժամանակահատված", "Выбранный период выручки", "Période de revenus sélectionnée"],
  ["SELECTED STATUS", "ԸՆՏՐՎԱԾ ԿԱՐԳԱՎԻՃԱԿ", "ВЫБРАННЫЙ СТАТУС", "STATUT SÉLECTIONNÉ"],
  ["This status represents {percent}% of {total} bookings in the selected period.", "Այս կարգավիճակը կազմում է ընտրված ժամանակահատվածի {total} ամրագրումների {percent}%-ը։", "Этот статус составляет {percent}% из {total} записей за выбранный период.", "Ce statut représente {percent}% des {total} réservations de la période sélectionnée."],
  ["SELECTED SERVICE", "ԸՆՏՐՎԱԾ ԾԱՌԱՅՈՒԹՅՈՒՆ", "ВЫБРАННАЯ УСЛУГА", "SERVICE SÉLECTIONNÉ"],
  ["{count} bookings · {share}% of busiest-service booking volume", "{count} ամրագրում · ամենաշատ ամրագրված ծառայության ծավալի {share}%", "{count} записей · {share}% от объёма самой бронируемой услуги", "{count} réservations · {share}% du volume du service le plus réservé"],
  ["{revenue} · {count} bookings · {share}% of busiest-service booking volume", "{revenue} · {count} ամրագրում · ամենաշատ ամրագրված ծառայության ծավալի {share}%", "{revenue} · {count} записей · {share}% от объёма самой бронируемой услуги", "{revenue} · {count} réservations · {share}% du volume du service le plus réservé"],
  ["SELECTED CLIENT SIGNAL", "ԸՆՏՐՎԱԾ ՀԱՃԱԽՈՐԴԱՅԻՆ ԱԶԴԱՆՇԱՆ", "ВЫБРАННЫЙ СИГНАЛ КЛИЕНТОВ", "SIGNAL CLIENT SÉLECTIONNÉ"],
  ["Share of active clients in this period who also had earlier activity.", "Այս ժամանակահատվածի ակտիվ հաճախորդների բաժինը, որոնք նաև ավելի վաղ ակտիվություն են ունեցել։", "Доля активных клиентов этого периода, у которых была активность и ранее.", "Part des clients actifs de cette période ayant aussi eu une activité antérieure."],
  ["Clients created or first seen during the selected period.", "Հաճախորդներ, որոնք ստեղծվել կամ առաջին անգամ հանդիպել են ընտրված ժամանակահատվածում։", "Клиенты, созданные или впервые замеченные в выбранном периоде.", "Clients créés ou observés pour la première fois pendant la période sélectionnée."],
  ["Clients with a completed appointment in the previous period but none in this period.", "Հաճախորդներ, որոնք նախորդ ժամանակահատվածում ավարտված այց են ունեցել, իսկ այս ժամանակահատվածում՝ ոչ։", "Клиенты с завершённой записью в предыдущем периоде, но без завершённой записи в текущем.", "Clients ayant eu un rendez-vous terminé sur la période précédente, mais aucun sur la période actuelle."],
  ["Clients whose completed revenue is at least twice the current average ticket.", "Հաճախորդներ, որոնց ավարտված այցերից եկամուտը առնվազն երկու անգամ գերազանցում է ընթացիկ միջին վճարումը։", "Клиенты, чья выручка по завершённым записям не менее чем вдвое превышает текущий средний чек.", "Clients dont le revenu des rendez-vous terminés atteint au moins deux fois le panier moyen actuel."],
  ["SELECTED DEMAND WINDOW", "ԸՆՏՐՎԱԾ ՊԱՀԱՆՋԱՐԿԻ ՄԻՋԱԿԱՅՔ", "ВЫБРАННЫЙ ИНТЕРВАЛ СПРОСА", "CRÉNEAU DE DEMANDE SÉLECTIONNÉ"],
  ["Demand intensity: {value}/5", "Պահանջարկի ինտենսիվություն՝ {value}/5", "Интенсивность спроса: {value}/5", "Intensité de la demande : {value}/5"],
  ["Low", "Ցածր", "Низкий", "Faible"],
  ["High", "Բարձր", "Высокий", "Élevé"],
  ["Selected period", "Ընտրված ժամանակահատված", "Выбранный период", "Période sélectionnée"],
  ["Data mode", "Տվյալների ռեժիմ", "Режим данных", "Mode de données"],
  ["Generated at", "Ստեղծման ժամանակը", "Сформировано", "Généré le"],
  ["Live", "Իրական", "Реальные данные", "Réel"],
  ["Preview", "Նախադիտում", "Предпросмотр", "Aperçu"],
  ["{count} bookings · {share}% vs the most-booked service", "{count} ամրագրում · {share}%՝ ամենաշատ ամրագրված ծառայության համեմատ", "{count} записей · {share}% относительно самой бронируемой услуги", "{count} réservations · {share}% par rapport au service le plus réservé"],
  ["Export ready in the system share sheet.", "Արտահանումը պատրաստ է համակարգային կիսման պատուհանում։", "Экспорт готов в системном меню общего доступа.", "L’export est prêt dans la feuille de partage système."],
  ["Export prepared, but sharing is unavailable on this device.", "Արտահանումը պատրաստ է, սակայն կիսումը հասանելի չէ այս սարքում։", "Экспорт подготовлен, но общий доступ недоступен на этом устройстве.", "L’export est prêt, mais le partage n’est pas disponible sur cet appareil."],
  ["Export could not be prepared.", "Չհաջողվեց պատրաստել արտահանումը։", "Не удалось подготовить экспорт.", "Impossible de préparer l’export."],
] as const;
