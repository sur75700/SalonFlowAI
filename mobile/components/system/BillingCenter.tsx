...
const BILLING_ITEMS: BillingItem[] = [
  { labelKey: "Payment Status", valueKey: "Billing Status Pending" },
  { labelKey: "Renewal State", valueKey: "Billing Renewal Pending" },
  { labelKey: "Next Invoice", valueKey: "Billing Invoice Pending" },
  { labelKey: "Billing Provider", valueKey: "Billing Provider Stripe" },
  { labelKey: "Stripe Integration", valueKey: "Billing Stripe Pending" },
];
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.summaryBox}>
        <Text style={styles.summaryValue}>{t("Billing Mode Foundation", locale)}</Text>
        <Text style={styles.summaryLabel}>{t("Billing Architecture", locale)}</Text>
      </View>
